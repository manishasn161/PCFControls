...
import {IProps, CustomGridControl}  from './component/CustomGridControl'

export class CustomGGridComponent implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	{	
		...
		if (!this._isModelApp)
		{
			...
			// will come back and do a reset on the paging.
			//@ts-ignore
		...
		ReactDOM.render(
			React.createElement(CustomGridControl, this._props), 
				this._detailList);
	}
	/** 
